...
ring_atoms = ['name CG', 'name CE1', 'name CD2', 'name ND1', 'name NE2']
# ----------------------------------

# 1) Load and center the molecule
cmd.load('./pdb/sche.pdb', mol_name)
cmd.center(mol_name)
...
# 4) Translate the molecule so its center lies at Z = 15.583 Å A CHANGER SELON LE RESIDU
cmd.translate([0, 0, 15.583], mol_name)
