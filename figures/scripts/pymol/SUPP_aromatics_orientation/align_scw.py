...
ring_atoms = ['name CD2', 'name CZ2', 'name CZ3', 'name CD1', 'name CE2', 'name CH2', 'name CE3']
# ----------------------------------

# 1) Load and center the molecule
cmd.load('./pdb/scw.pdb', mol_name)
cmd.center(mol_name)
...
# 4) Translate the molecule so its center lies at Z = 12.097 Å A CHANGER SELON LE RESIDU
cmd.translate([0, 0, 12.097], mol_name)
