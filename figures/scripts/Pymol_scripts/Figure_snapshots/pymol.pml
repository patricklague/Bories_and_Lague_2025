...
# Select all analog molecules
select analogs, resname SC* or resname GLYD
show spheres, analogs
color cyan, analog and elem C
...
#hide labels
set sphere_transparency, 0.4, waters
set sphere_transparency, 0.4, P_atoms or N_atoms
set stick_transparency, 0.4, lipid_tails
